...
try:
    ...
    from labelImg.libs.lightWidget import LightWidget
    from labelImg.libs.lightWidget import LightWidget
...
__appname__ = 'labelImg for auxlabel_tool_yolov8'
...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, default_filename=None, default_prefdef_class_file=None, default_save_dir=None):
        ...
        save_format = action(get_format_meta()[0], self.change_format, 'Ctrl+Y', get_format_meta()[1],
    ...
    def open_dir_dialog(self, _value=False, dir_path=None, silent=False):
        ...
        # TODO:注释掉这行代码是因为其会导致save_dir参数无法正常被调用，尚不知会有什么副作用，先标记一下
...
def get_main_app(input_image_dir, input_class_file, input_save_dir, argv=None):
    """
    ...
    win = MainWindow(input_image_dir, input_class_file, input_save_dir)
    win.show()
    return app, win


def main(image_dir, class_file, save_dir):
    """construct main app and run it"""
    app, _win = get_main_app(image_dir, class_file, save_dir, sys.argv)
    return app.exec_()
